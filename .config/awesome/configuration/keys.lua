...
local latam = require("ui.bar")
local layout_indicator = require("keyboard-layout-indicator")

-- for keyboard_layout mappings
local kbdcfg = layout_indicator({
    layouts = {
        {name="us", layout="us", variant=nil},
        {name="es", layout="latam", variant=nil},
        {name='dv', layout="us", variant="dvorak"}
    },
    -- Remap caps to escape <3
    post_set_hooks = {
        "xmodmap ~/.Xmodmap",
